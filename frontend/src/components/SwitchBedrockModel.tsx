        ...
        {() => (
          <>
            <Popover.Button
              className={`${
                props.className ?? ''
              } group inline-flex w-auto whitespace-nowrap rounded border-aws-squid-ink-light/50 dark:border-aws-squid-ink-dark/50 bg-aws-paper-light dark:bg-aws-paper-dark p-2 px-3 text-sm hover:brightness-75`}>
              <div className="flex items-center justify-between font-semibold text-dark-gray dark:text-light-gray">
                <span>{modelName}</span>
