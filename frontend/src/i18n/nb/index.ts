...
Hvordan vil du kategorisere denne e-posten?`,
        ...
        admin: {
            sharedBotAnalytics: {
                label: {
                    ...
                    noPublicBotUsages:
                        'I løpet av beregningsperioden ble ingen offentlige boter brukt.',
                ...
                help: {
                    overview:
                        'Overvåk bruksstatusen for delte boter og publiserte bot-API-er.',
                    calculationPeriod:
        ...
        button: {
            ...
            sharedBotAnalytics: 'Analyser for delt bot',
