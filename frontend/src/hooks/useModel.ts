    ...
    return !MISTRAL_ENABLED
      ? [
          ...
          //Llama models
          {
            ...
            label: t('Llama model 3'),
            description: t('Basic Llama Model'),
            supportMediaType: [],
            supportReasoning: false,
          },
          {
            modelId: 'llama-3-1-8b-instruct',
            label: t('Llama model 3.1'),
            description: t('Llama Model 3.1'),
            supportMediaType: [],
            supportReasoning: false,
          },
          {
            modelId: 'llama-3-2-1b-instruct',
            label: t('Llama model 3.2'),
            description: t('Llama Model 3.2'),
            supportMediaType: [],
            supportReasoning: false,
          },
          {
            modelId: 'llama-3-3-70b-instruct',
            label: t('Llama model 3.3'),
            description: t('Llama Model 3.3'),
            supportMediaType: [],
            supportReasoning: false,
          },
        ]
