...
I bot pubblici possono ora essere contrassegnati come "Essenziali" dagli amministratori. I bot contrassegnati come Essenziali saranno presentati nella sezione "Essenziali" dello store dei bot, rendendoli facilmente accessibili agli utenti. Questo consente agli amministratori di evidenziare bot importanti che vogliono che tutti gli utenti utilizzino.
...
- Bot Guida alle Politiche Interne: Risponde a domande frequenti su regole di presenza, politiche di sicurezza e altri regolamenti interni.
...
## Scaricare i dati della conversazione
