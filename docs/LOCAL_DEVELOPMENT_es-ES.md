...
En este ejemplo, puede modificar y lanzar localmente el frontend utilizando recursos de AWS (`API Gateway`, `Cognito`, etc.) que se han implementado con `npx cdk deploy`.

1. Consulte [Deploy using CDK](../README.md#deploy-using-cdk) para la implementación en el entorno AWS.
...
## (Opcional, recomendado) Configuración del hook pre-commit
