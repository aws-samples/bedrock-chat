...
- Vi har introdusert `CreatingBotAllowed` Cognito-brukergruppe for å begrense brukere som kan opprette bots. Eksisterende brukere er ikke i denne gruppen, så du må manuelt legge til tillatelsen hvis du vil at de skal ha mulighet til å opprette bots. Se: [Bot Personalization](../../README.md#bot-personalization)
...
- Bekreft om brukeren kan opprette en bot. Merk at brukerne må logge på på nytt.