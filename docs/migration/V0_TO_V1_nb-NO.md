...
- Vi har introdusert Cognito-brukergruppen `CreatingBotAllowed` for å begrense brukere som kan opprette bots. Eksisterende brukere er ikke i denne gruppen, så du må manuelt legge til tillatelsen hvis du vil at de skal kunne opprette bots. Se: [Bot Personalization](../../README.md#bot-personalization)
...
### Migrering av vektorlagring

- Åpne terminalen din og naviger til prosjektkatalogen
- Hent branchen du vil distribuere. Bytt til ønsket branch (i dette tilfellet `v1`) og hent de siste endringene:
...
### Tilknytt CreatingBotAllowed-tillatelse
