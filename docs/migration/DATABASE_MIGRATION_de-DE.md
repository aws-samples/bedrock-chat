...
Dieser Leitfaden beschreibt die Schritte zur Datenmigration bei der Aktualisierung von Bedrock Claude Chat, die eine Ersetzung des Aurora-Clusters beinhaltet. Das folgende Verfahren gewährleistet einen reibungslosen Übergang bei minimaler Ausfallzeit und Datenverlust.
...
Wenn Sie die oben genannte Methode aufgrund von Zeit- und Kostenimplikationen nicht nutzen möchten, ziehen Sie die folgenden alternativen Ansätze in Betracht:
