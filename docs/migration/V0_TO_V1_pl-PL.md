...
- Jeśli chcesz przywrócić elementy za pomocą DMS, PAMIĘTAJ o wyłączeniu rotacji hasła i zanotowaniu hasła dostępu do bazy danych. Jeśli przywracasz za pomocą skryptu migracji([migrate.py](./migrate.py)), nie musisz notować hasła.
