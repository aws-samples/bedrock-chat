...
- El almacenamiento de la base de datos vectorial (es decir, pgvector en Aurora PostgreSQL) ahora está cifrado, lo que provoca un reemplazo cuando se implementa. Esto significa que los elementos vectoriales existentes se eliminarán.
