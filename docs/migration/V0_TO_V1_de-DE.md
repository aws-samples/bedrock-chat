# Migrations-Leitfaden (v0 bis v1)
...
Lesen Sie den [Leitfaden zur Datenbankwanderung](./DATABASE_MIGRATION_de-DE.md) und bestimmen Sie die Methode zum Wiederherstellen von Elementen.
...
- Überprüfen Sie, ob Benutzer vorhandene Bots mit Wissen nutzen können, d.h. RAG-Bots.

### Berechtigung "Bot erstellen erlaubt" hinzufügen
