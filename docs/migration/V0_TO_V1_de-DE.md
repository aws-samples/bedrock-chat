...
Lesen Sie den [Datenbankmigrationsleitfaden](./DATABASE_MIGRATION_de-DE.md) und bestimmen Sie die Methode zum Wiederherstellen von Elementen.
...
- Folgen Sie dem [Datenbank-Migrationshandbuch](./DATABASE_MIGRATION_de-DE.md), um Vektorelemente wiederherzustellen.
