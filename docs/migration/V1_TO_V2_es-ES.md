...
- Tenga en cuenta que **actualizar a v2 resultará en la eliminación de todos los recursos relacionados con Aurora.** Las futuras actualizaciones se centrarán exclusivamente en v2, quedando v1 obsoleta.
