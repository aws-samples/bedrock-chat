...
- L'archiviazione del database vettoriale (ovvero, pgvector su Aurora PostgreSQL) è ora crittografata, il che innesca una sostituzione durante la distribuzione. Questo significa che gli elementi vettoriali esistenti verranno eliminati.
