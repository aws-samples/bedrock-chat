...
Questo aggiornamento principale include importanti aggiornamenti di sicurezza.

- L'archiviazione del database vettoriale (ovvero, pgvector su Aurora PostgreSQL) è ora crittografata, il che comporta una sostituzione al momento della distribuzione. Questo significa che gli elementi vettoriali esistenti verranno eliminati.
