...
- L'archiviazione del database vettoriale (cioè pgvector su Aurora PostgreSQL) è ora crittografata, il che attiva una sostituzione durante la distribuzione. Questo significa che gli elementi vettoriali esistenti verranno eliminati.
...
- Fai il pull del branch che desideri deployare. Di seguito per il branch desiderato (in questo caso, `v1`) e pull delle ultime modifiche:
...
- Verifica che gli utenti possano utilizzare i bot esistenti che hanno conoscenza, ad esempio i bot RAG.

### Aggiungere il permesso CreatingBotAllowed

- Dopo il deployment, tutti gli utenti non potranno creare nuovi bot.
- Se vuoi che specifici utenti possano creare bot, aggiungi questi utenti al gruppo `CreatingBotAllowed` utilizzando la console di gestione o la CLI.
