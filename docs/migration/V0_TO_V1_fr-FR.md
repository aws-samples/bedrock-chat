...
- Extrayez la branche que vous souhaitez déployer. Basculez vers la branche souhaitée (dans ce cas, `v1`) et récupérez les dernières modifications :
