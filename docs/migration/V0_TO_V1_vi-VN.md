...
Nếu bạn đã sử dụng Bedrock Chat với phiên bản trước đó (~`0.4.x`), bạn cần thực hiện theo các bước dưới đây để di chuyển.
...
- Chúng tôi đã giới thiệu nhóm người dùng Cognito `CreatingBotAllowed` để hạn chế người dùng có thể tạo bot. Người dùng hiện có không thuộc nhóm này, vì vậy bạn cần gắn quyền một cách thủ công nếu muốn họ có khả năng tạo bot. Xem: [Cá nhân hóa Bot](../../README.md#bot-personalization)
...
- Loại bỏ tất cả các [API đã xuất bản](../PUBLISH_API_vi-VN.md) để CloudFormation có thể loại bỏ cụm Aurora hiện tại.
...
- Nếu bạn muốn một số người dùng cụ thể có thể tạo bot, hãy thêm những người dùng đó vào nhóm `CreatingBotAllowed` bằng cách sử dụng bảng điều khiển quản lý hoặc CLI.
