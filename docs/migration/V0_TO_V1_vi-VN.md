...
- Chúng tôi đã giới thiệu nhóm người dùng Cognito `CreatingBotAllowed` để hạn chế người dùng có thể tạo bot. Người dùng hiện có không thuộc nhóm này, vì vậy bạn cần gắn quyền theo cách thủ công nếu muốn họ có khả năng tạo bot. Xem: [Cá nhân hóa Bot](../../README.md#bot-personalization)
...
- Xóa tất cả [các API đã xuất bản](../PUBLISH_API_vi-VN.md) để CloudFormation có thể loại bỏ cụm Aurora hiện có.
