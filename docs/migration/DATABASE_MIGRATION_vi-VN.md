...
Hướng dẫn này trình bày các bước để di chuyển dữ liệu khi thực hiện cập nhật Bedrock Claude Chat, bao gồm việc thay thế cụm Aurora. Quy trình sau đảm bảo quá trình chuyển đổi diễn ra suôn sẻ, giảm thiểu thời gian ngừng hoạt động và mất mát dữ liệu.
