...
- Tarik cabang yang anda ingin deploy. Berikut adalah ke cabang yang diinginkan (dalam kes ini, `v1`) dan tarik perubahan terkini:
...
- Buang semua [API yang diterbitkan](../PUBLISH_API_ms-MY.md) supaya CloudFormation dapat mengeluarkan kluster Aurora sedia ada.
...
- Semak sama ada pengguna dapat membuat bot. Perhatikan bahawa pengguna perlu log masuk semula.