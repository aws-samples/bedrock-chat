...
- Tarik cawangan yang ingin anda deploy. Berikut adalah untuk cawangan yang dikehendaki (dalam kes ini, `v1`) dan tarik perubahan terkini:
...
- Jalankan [npx cdk deploy](../README.md#deploy-using-cdk) yang mencetus penggantian kluster Aurora dan MEMADAM SEMUA ITEM VEKTOR.
