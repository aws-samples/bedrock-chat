...
Najpierw zanotuj hasło dostępu do obecnego klastra Aurora. Następnie uruchom `npx cdk deploy`, co spowoduje wymianę klastra. Potem utwórz tymczasową bazę danych poprzez przywrócenie jej ze snapshota oryginalnej bazy danych.
...
Rozważ specyficzne wymagania i ograniczenia swojego projektu przy wyborze najbardziej odpowiedniego podejścia do migracji.