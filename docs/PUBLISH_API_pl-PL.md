...
Po zalogowaniu się jako użytkownik `PublishedAllowed` i utworzeniu bota wybierz `Ustawienia publikacji API`. Należy pamiętać, że opublikować można tylko wspólnego bota.
