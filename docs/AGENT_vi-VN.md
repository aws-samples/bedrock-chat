...
Một người dùng yêu cầu "tổng doanh số bán hàng của quý vừa qua". Đại Lý sẽ hiểu yêu cầu này, chuyển đổi nó thành một truy vấn SQL, thực thi truy vấn trên cơ sở dữ liệu, và trình bày kết quả.

### Dự Báo Tài Chính

Một chuyên viên tài chính cần dự báo doanh thu của quý tới. Đại Lý sẽ thu thập dữ liệu có liên quan, thực hiện các phép tính cần thiết bằng các mô hình tài chính, và tạo ra một báo cáo dự báo chi tiết, đảm bảo tính chính xác của các dự đoán.
...
3. Để kích hoạt một công cụ, chỉ cần chuyển công tắc bên cạnh công cụ mong muốn. Một khi công cụ được bật, Agent sẽ có quyền truy cập và có thể sử dụng nó khi xử lý truy vấn của người dùng.
...
Công cụ này phụ thuộc vào [DuckDuckGo](https://duckduckgo.com/) có giới hạn tỷ lệ. Nó phù hợp cho mục đích PoC hoặc demo, nhưng nếu bạn muốn sử dụng cho môi trường sản xuất, chúng tôi khuyến nghị sử dụng API tìm kiếm khác.
...
**Chúng tôi hoan nghênh các đóng góp vào kho lưu trữ công cụ!** Nếu bạn phát triển một công cụ hữu ích và được triển khai tốt, hãy cân nhắc đóng góp nó cho dự án bằng cách gửi một issue hoặc pull request.