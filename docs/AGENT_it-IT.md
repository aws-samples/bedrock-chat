...
Un analista finanziario necessita di prevedere il fatturato del prossimo trimestre. L'Agente raccoglie i dati rilevanti, esegue i calcoli necessari utilizzando modelli finanziari e genera un report di previsione dettagliato, garantendo l'accuratezza delle proiezioni.
...
3. Per attivare uno strumento, basta cambiare l'interruttore accanto allo strumento desiderato. Una volta abilitato uno strumento, l'Agente avrà accesso ad esso e potrà utilizzarlo durante l'elaborazione delle query degli utenti.

![](./imgs/agent_tools.png)

> [!Importante]
> È importante notare che l'abilitazione di qualsiasi strumento nella sezione Agente tratterà automaticamente la funzionalità ["Conoscenza"](https://aws.amazon.com/what-is/retrieval-augmented-generation/) come uno strumento. Ciò significa che l'LLM determinerà autonomamente se utilizzare la "Conoscenza" per rispondere alle query degli utenti, considerandola come uno degli strumenti disponibili.
