...
## (Tùy chọn, khuyến nghị) Thiết lập hook trước khi commit

Chúng tôi đã giới thiệu các quy trình GitHub để kiểm tra kiểu và kiểm tra lỗi. Những quy trình này được thực thi khi một Pull Request được tạo, nhưng việc chờ đợi quá trình kiểm tra lỗi hoàn tất trước khi tiếp tục không phải là trải nghiệm phát triển tốt. Do đó, các tác vụ kiểm tra lỗi này nên được thực hiện tự động tại giai đoạn commit. Chúng tôi đã giới thiệu [Lefthook](https://github.com/evilmartians/lefthook?tab=readme-ov-file#install) như một cơ chế để đạt được điều này. Việc sử dụng không bắt buộc, nhưng chúng tôi khuyến nghị áp dụng để có trải nghiệm phát triển hiệu quả. Ngoài ra, mặc dù chúng tôi không áp đặt việc định dạng TypeScript với [Prettier](https://prettier.io/), nhưng chúng tôi rất mong bạn có thể áp dụng khi đóng góp, vì nó giúp ngăn chặn các thay đổi không cần thiết trong quá trình xem xét mã.
