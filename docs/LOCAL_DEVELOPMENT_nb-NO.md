...
I denne eksempelet kan du lokalt modifisere og starte frontend ved hjelp av AWS-ressurser (`API Gateway`, `Cognito`, osv.) som er distribuert med `npx cdk deploy`.
...
For mer detaljer, vennligst sjekk [backend README](../backend/README_nb-NO.md).
