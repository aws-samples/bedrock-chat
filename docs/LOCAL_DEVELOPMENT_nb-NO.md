...
I denne eksempelet kan du lokalt modifisere og lansere frontend-en ved hjelp av AWS-ressurser (`API Gateway`, `Cognito`, osv.) som er blitt distribuert med `npx cdk deploy`.
