...
Pada masa ini menyediakan gambaran keseluruhan asas penggunaan chatbot dan pengguna, dengan fokus pada pengumpulan data untuk setiap bot dan pengguna dalam tempoh masa yang ditetapkan dan mengisih keputusan mengikut yuran penggunaan.
...
Edit `bot-id` dan `datehour`. `bot-id` boleh dirujuk pada skrin Pengurusan Bot, yang boleh diakses dari Bot Publish APIs, ditunjukkan pada sidebar sebelah kiri. Ambil perhatian bahagian akhir URL seperti `https://xxxx.cloudfront.net/admin/bot/<bot-id>`.
