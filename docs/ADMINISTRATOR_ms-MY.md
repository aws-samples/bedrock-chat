...
Bot awam kini boleh ditandakan sebagai "Penting" oleh pentadbir. Bot yang ditandakan sebagai Penting akan dipaparkan dalam bahagian "Penting" di kedai bot, menjadikannya mudah diakses oleh pengguna. Ini membolehkan pentadbir meletakkan bot penting yang mereka ingin semua pengguna gunakan.
...
- Bot Maklumat Faedah: Menjelaskan program faedah syarikat dan perkhidmatan kebajikan.
...
Output daripada LLM mungkin tidak sentiasa memenuhi jangkaan pengguna. Kadang-kala ia gagal memuaskan keperluan pengguna. Untuk mengintegrasikan LLM ke dalam operasi perniagaan dan kehidupan harian secara berkesan, melaksanakan gelung maklum balas adalah penting. Bedrock Chat dilengkapi dengan fitur maklum balas yang direka untuk membolehkan pengguna menganalisis mengapa ketidakpuasan berlaku. Berdasarkan keputusan analisis, pengguna boleh melaraskan petunjuk, sumber data RAG, dan parameter dengan sewajarnya.
...
Saat ini menyediakan gambaran umum asas tentang penggunaan chatbot dan pengguna, dengan fokus pada pengumpulan data untuk setiap bot dan pengguna dalam tempoh masa yang ditetapkan dan mengisih keputusan mengikut yuran penggunaan.
...
> [!Penting]
> Jika anda menggunakan berbilang persekitaran (dev, prod, dll.), nama pangkalan data Athena akan merangkumi awalan persekitaran. Daripada `bedrockchatstack_usage_analysis`, nama pangkalan data akan menjadi:
>
