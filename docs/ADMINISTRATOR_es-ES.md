...
Los analistas de datos pueden acceder a los registros de conversación utilizando [Amazon Athena](https://aws.amazon.com/jp/athena/). Si desean analizar los datos con [Jupyter Notebook](https://jupyter.org/), [este ejemplo de notebook](../examples/notebooks/feedback_analysis_example.ipynb) puede ser una referencia.
...
- En los usos de bots públicos, los bots que no se hayan utilizado en absoluto durante el período especificado no se mostrarán.
