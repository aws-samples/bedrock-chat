...
Trên màn hình tiếp theo, chúng ta có thể định cấu hình một số tham số liên quan đến điều tiết. Để biết chi tiết, vui lòng xem thêm: [Điều tiết yêu cầu API để cải thiện thông lượng](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html).
