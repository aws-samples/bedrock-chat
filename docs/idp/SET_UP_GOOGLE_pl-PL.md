...
5. Postępuj zgodnie z monitami, aby nazwać i opisać sekret. Zanotuj nazwę sekretną, ponieważ będzie ona potrzebna w kodzie CDK. Na przykład, googleOAuthCredentials. (Użyj w nazwie zmiennej w Kroku 3 <YOUR_SECRET_NAME>)
...
Po wdrożeniu stosu, AuthApprovedRedirectURI będzie widoczny w danych wyjściowych CloudFormation. Wróć do konsoli Google Developer Console i zaktualizuj klienta OAuth o poprawne adresy URL przekierowania.