...
3. Wybierz "Inny rodzaj sekretów".
...
5. Postępuj zgodnie z monitami, aby nazwać i opisać sekret. Zanotuj nazwę sekreta, ponieważ będzie ona potrzebna w kodzie CDK. Na przykład, googleOAuthCredentials. (Użyj w nazwie zmiennej kroku 3 <YOUR_SECRET_NAME>)
...
## Krok 5: Aktualizacja klienta Google OAuth identyfikatorami URI przekierowania Cognito
