...
Følg prosedyrene for den aktuelle OIDC-leverandøren, og noter verdiene for OIDC-klient-ID og hemmelighet. Utsteder-URL er også nødvendig i de følgende trinnene. Hvis omdirigerings-URI kreves i oppsettsprosessen, angir du en midlertidig verdi som vil bli erstattet etter at distribusjonen er fullført.
    ...
    "identityProviders": [
      {
        ...
        "secretName": "<DITT_HEMMELIGHETNAVN>"
      }
    ],
...
## Trinn 5: Oppdater OIDC-klient med Cognito-omdirigerings-URIer

Etter at stakken er distribuert, vil `AuthApprovedRedirectURI` vises i CloudFormation-resultatene. Gå tilbake til OIDC-konfigurasjonen din og oppdater med de riktige omdirigerings-URIene.