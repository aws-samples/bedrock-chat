...
Dopo aver distribuito lo stack, `AuthApprovedRedirectURI` sarà visibile nell'output di CloudFormation. Torna alla configurazione OIDC e aggiorna gli URI di reindirizzamento corretti.