...
4. Inserisci l'ID client e il client secret come coppie chiave-valore.
...
5. Segui le istruzioni per denominare e descrivere il segreto. Prendi nota del nome del segreto poiché ti servirà nel codice CDK (Utilizzato nel Passaggio 3 con il nome variabile <YOUR_SECRET_NAME>).
    ...
    "identityProviders": [
      {
        ...
        "serviceName": "<TUO_NOME_SERVIZIO>", // Imposta un valore a tua scelta
