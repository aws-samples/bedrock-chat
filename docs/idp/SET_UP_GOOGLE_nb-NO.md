...
## Steg 2: Lagre Google OAuth-legitimasjon i AWS Secrets Manager
...
5. Følg instruksjonene for å navngi og beskrive hemmeligheten. Merk deg navnet på hemmeligheten da du vil trenge det i CDK-koden din. For eksempel, googleOAuthCredentials.(Bruk i Steg 3 variabelnavn <YOUR_SECRET_NAME>)
...
userPoolDomainPrefix må være globalt unik på tvers av alle Amazon Cognito-brukere. Hvis du velger et prefiks som allerede er i bruk av en annen AWS-konto, vil opprettelsen av brukerens pool-domene mislykkes. Det er god praksis å inkludere identifikatorer, prosjektnavn eller miljønavn i prefikset for å sikre unikhet.
...
## Steg 5: Oppdater Google OAuth-klienten med Cognito-omdirigeringsadresser

Etter at stacken er distribuert, vises AuthApprovedRedirectURI i CloudFormation-utdataene. Gå tilbake til Google Developer Console og oppdater OAuth-klienten med de korrekte omdirigeringsadressene.