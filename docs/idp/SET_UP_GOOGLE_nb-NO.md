...
For flere detaljer, besøk [Googles offisielle dokument](https://support.google.com/cloud/answer/6158849?hl=en)
...
5. Følg instruksjonene for å gi navn og beskrivelse til hemmeligheten. Merk deg hemmelighetens navn da du vil trenge det i din CDK-kode. For eksempel googleOAuthCredentials. (Brukes i Trinn 3 variabelnavn <YOUR_SECRET_NAME>)
