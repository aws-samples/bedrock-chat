    ...
    "identityProviders": [
      {
        ...
        "serviceName": "<SU_NOMBRE_DE_SERVICIO>", // Establezca cualquier valor que le guste
...
Después de desplegar la pila, `AuthApprovedRedirectURI` aparecerá en las salidas de CloudFormation. Vuelva a su configuración de OIDC y actualice con los URI de redirección correctos.