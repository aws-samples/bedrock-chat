...
5. Siga las indicaciones para nombrar y describir el secreto. Tome nota del nombre del secreto, ya que lo necesitará en su código CDK (Utilizado en el nombre de variable <YOUR_SECRET_NAME> del Paso 3).
