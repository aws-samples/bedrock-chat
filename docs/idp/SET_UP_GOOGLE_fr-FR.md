...
6. Laissez l'URI de redirection vide pour le moment afin de le définir plus tard, et sauvegardez temporairement.[Voir l'étape 5](#step-5-update-google-oauth-client-with-cognito-redirect-uris)
...
4. Saisissez le clientId et le clientSecret Google OAuth sous forme de paires clé-valeur.
