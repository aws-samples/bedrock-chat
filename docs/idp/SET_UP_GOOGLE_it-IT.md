...
5. Segui le istruzioni per assegnare un nome e una descrizione al segreto. Prendi nota del nome del segreto poiché ti servirà nel codice CDK. Ad esempio, googleOAuthCredentials. (Da utilizzare nel nome della variabile del Passaggio 3 <YOUR_SECRET_NAME>)
