...
ทำตามขั้นตอนสำหรับผู้ให้บริการ OIDC เป้าหมาย และจดบันทึกค่าสำหรับรหัสไคลเอนต์ OIDC และรหัสลับ นอกจากนี้ยังต้องใช้ URL ของผู้ออกใบรับรองในขั้นตอนต่อไป หากจำเป็นต้องใช้ URI การเปลี่ยนเส้นทาง ให้ป้อนค่าตัวอย่าง ซึ่งจะถูกแทนที่หลังจากการปรับใช้เสร็จสมบูรณ์

## ขั้นตอนที่ 2: จัดเก็บข้อมูลประจำตัวใน AWS Secrets Manager

1. ไปที่คอนโซลการจัดการ AWS
2. นำทางไปยัง Secrets Manager และเลือก "จัดเก็บความลับใหม่"
3. เลือก "ประเภทความลับอื่น"
...
5. ทำตามคำแนะนำเพื่อตั้งชื่อและอธิบายความลับ สังเกตชื่อความลับเนื่องจากคุณจะต้องใช้ในโค้ด CDK (ใช้ในตัวแปรขั้นตอนที่ 3 <YOUR_SECRET_NAME>)
...
หลังจากปรับใช้สแต็ค `AuthApprovedRedirectURI` จะปรากฏในผลลัพธ์ของ CloudFormation ให้กลับไปยังการกำหนดค่า OIDC ของคุณและอัปเดตด้วย URIs การเปลี่ยนเส้นทางที่ถูกต้อง