...
Ikuti prosedur untuk penyedia OIDC yang disasarkan, dan catat nilai untuk ID klien OIDC dan rahsia. URL pengeluar juga diperlukan pada langkah berikutnya. Jika URI peralihan diperlukan untuk proses persediaan, masukkan nilai tiruan, yang akan diganti selepas pengplotan selesai.
...
5. Ikuti petunjuk untuk menamakan dan menggambarkan rahsia. Catat nama rahsia kerana anda akan memerlukannya dalam kod CDK anda (Digunakan dalam nama variabel Langkah 3 <YOUR_SECRET_NAME>).
    ...
    "identityProviders": [
      {
        ...
        "serviceName": "<NAMA_PERKHIDMATAN_ANDA>", // Tetapkan nilai apa pun yang anda suka
