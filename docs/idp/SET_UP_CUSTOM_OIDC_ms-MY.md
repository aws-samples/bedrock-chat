...
Ikuti prosedur untuk penyedia OIDC yang dituju, dan catat nilai untuk ID klien OIDC dan rahsia. URL pengeluar juga diperlukan pada langkah berikutnya. Jika URI pengalihan diperlukan dalam proses penyediaan, masukkan nilai tiruan, yang akan diganti selepas pengepala siap.
...
Nama kunci mestilah sepadan dengan rentetan `clientId`, `clientSecret` dan `issuerUrl`.
