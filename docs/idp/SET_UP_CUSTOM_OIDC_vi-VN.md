...
5. Làm theo các hướng dẫn để đặt tên và mô tả secret. Ghi nhớ tên secret vì bạn sẽ cần nó trong mã CDK của mình (Được sử dụng trong tên biến Bước 3 <YOUR_SECRET_NAME>).
    ...
    "identityProviders": [
      {
        ...
        "serviceName": "<YOUR_SERVICE_NAME>", // Đặt bất kỳ giá trị nào bạn thích
