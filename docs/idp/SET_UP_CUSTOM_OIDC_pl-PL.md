...
Po wdrożeniu stosu `AuthApprovedRedirectURI` pojawi się w danych wyjściowych CloudFormation. Wróć do konfiguracji OIDC i zaktualizuj ją, używając poprawnych adresów URL przekierowania.