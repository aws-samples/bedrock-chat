...
5. Postępuj zgodnie z instrukcjami, aby nazwać i opisać sekret. Zanotuj nazwę sekretu, ponieważ będzie Ci ona potrzebna w kodzie CDK (używana w zmiennej kroku 3 <YOUR_SECRET_NAME>).
...
## Krok 5: Aktualizacja klienta OIDC z adresami URL przekierowania Cognito
