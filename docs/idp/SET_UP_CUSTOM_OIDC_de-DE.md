...
Fügen Sie in Ihrer cdk.json-Datei die ID des Anbieters und den geheimen Namen zur cdk.json-Datei hinzu.
...
```json
{
  "context": {
    ...
    "userPoolDomainPrefix": "<EINDEUTIGES_DOMÄNENPRÄFIX_FÜR_IHREN_BENUTZER-POOL>"
  }
}
```
