...
Sur l'écran suivant, vous pouvez configurer plusieurs paramètres concernant la limitation de débit. Pour plus de détails, veuillez consulter : [Limiter les requêtes API pour un meilleur débit](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-request-throttling.html).
